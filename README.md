...
<p>Le fichier <a href="./.env.txt" target="_blank">.env</a> (que vous devrez renommer <code>.env</code>) vous permet de modifier les paramètres de DayZ Logger tout en gardant les valeurs secrète.<br>
...
<table>
    ...
    <tbody align="center">
        ...
        <a name="LANGUAGES"></a>
        <tr>
            <td style="text-align:center"><a href="./languages.js" target="_blank">languages</a></td>
...
<table>
    ...
    <tbody align="center">
        ...
        <tr>
            <td style="text-align:center">FOOTERICONURL</td>
            <td style="text-align:center"><a href="#SENDDISCORDWEBHOOKS">SENDDISCORDWEBHOOKS</a></td>
            <td style="text-align:center">String</td>
...
<table>
    ...
    <tbody align="center">
        ...
        <tr>
            ...
            <td style="text-align:center">Quand un joueur démonte un objet</td>
            <td style="text-align:center"><a href="#EVENTSVARIABLES_DATE">DATE</a>, <a href="#EVENTSVARIABLES_PLAYER">PLAYER</a>, <a href="#EVENTSVARIABLES_PLAYERID">PLAYERID</a>, <a href="#EVENTSVARIABLES_PLAYERPOSITION">PLAYERPOSITION</a>, <a href="#EVENTSVARIABLES_OBJECT">OBJECT</a> <a href="#EVENTSVARIABLES_TOOL">TOOL</a></td>
        </tr>
...
<table>
    ...
    <tbody align="center">
        ...
        <tr>
            ...
            <td style="text-align:center">La liste de tout les joueurs connecté</td>
        </tr>
    </tbody>
</table>
...
<table>
    ...
    <tbody align="center">
        ...
        <tr>
            ...
            <td style="text-align:center">chernarusplus</td>
        </tr>
...
<table>
    ...
    <tbody align="center">
        ...
        <tr>
            <td style="text-align:center">UNCONSCIOUSDISCORDWEBHOOKSICONURL</td>
            <td style="text-align:center">L'url de l'icône du webhook Discord pour l'événement</td>
            <td style="text-align:center">Optionnel si DISCORDWEBHOOKSICONURL est définie</td>
        </tr>
...
<table>
    ...
    <tbody align="center">
        ...
        <tr>
            <td style="text-align:center">HITGENERICDISCORDWEBHOOKSICONURL</td>
            <td style="text-align:center">L'url de l'icône du webhook Discord pour l'événement</td>
            <td style="text-align:center">Optionnel si DISCORDWEBHOOKSICONURL est définie</td>
        </tr>
...
<table>
    ...
    <tbody align="center">
        ...
        <tr>
            <td style="text-align:center">DEATHMELEEPLAYERDISCORDWEBHOOKSICONURL</td>
            <td style="text-align:center">L'url de l'icône du webhook Discord pour l'événement</td>
            <td style="text-align:center">Optionnel si DISCORDWEBHOOKSICONURL est définie</td>
        </tr>
        <a name="DEATHMELEEPLAYERCOLOR"></a>
        <tr>
            <td style="text-align:center">DEATHMELEEPLAYERCOLOR</td>
            <td style="text-align:center">La couleur de l'embed pour l'événement</td>
            <td style="text-align:center">#d80000</td>
        </tr>
        <a name="DEATHMELEEPLAYERINLINE"></a>
        <tr>
            <td style="text-align:center">DEATHMELEEPLAYERINLINE</td>
            <td style="text-align:center">Aligner tout les champs</td>
            <td style="text-align:center">false</td>
        </tr>
    </tbody>
...
<table>
    <thead align="center">
        <a name="DEATHMELEE"></a>
        <tr>
            <th style="text-align:center">DEATHMELEE</th>
            <th style="text-align:center">Quand un joueur décède de la part d'une entité</th>
            <th style="text-align:center">true</th>
        </tr>
    </thead>
    <tbody align="center">
        <a name="DEATHMELEEDISCORDWEBHOOKS"></a>
        <tr>
            <td style="text-align:center">DEATHMELEEDISCORDWEBHOOKS</td>
            <td style="text-align:center">Activé/désactivé les webkooks Discord pour l'événement</td>
            <td style="text-align:center">true</td>
        </tr>
        <a name="DEATHMELEEDISCORDWEBHOOKSLINKS"></a>
        <tr>
            <td style="text-align:center">DEATHMELEEDISCORDWEBHOOKSLINKS</td>
            <td style="text-align:center">Le/les lien(s) du/des webhook(s) Discord pour l'événement</td>
            <td style="text-align:center">Optionnel si DISCORDWEBHOOKSLINKS est définie</td>
        </tr>
        <a name="DEATHMELEEDISCORDWEBHOOKSNAME"></a>
        <tr>
            <td style="text-align:center">DEATHMELEEDISCORDWEBHOOKSNAME</td>
            <td style="text-align:center">Le nom du webhook Discord pour l'événement</td>
            <td style="text-align:center">Optionnel si DISCORDWEBHOOKSNAME est définie</td>
        </tr>
        <a name="DEATHMELEEDISCORDWEBHOOKSICONURL"></a>
        <tr>
            <td style="text-align:center">DEATHMELEEDISCORDWEBHOOKSICONURL</td>
            <td style="text-align:center">L'url de l'icône du webhook Discord pour l'événement</td>
            <td style="text-align:center">Optionnel si DISCORDWEBHOOKSICONURL est définie</td>
        </tr>
        <a name="DEATHMELEECOLOR"></a>
        <tr>
            <td style="text-align:center">DEATHMELEECOLOR</td>
            <td style="text-align:center">La couleur de l'embed pour l'événement</td>
            <td style="text-align:center">#d80000</td>
        </tr>
        <a name="DEATHMELEEINLINE"></a>
        <tr>
            <td style="text-align:center">DEATHMELEEINLINE</td>
            <td style="text-align:center">Aligner tout les champs</td>
            <td style="text-align:center">false</td>
        </tr>
    </tbody>
...
<table>
    <thead align="center">
        <a name="DEATHSTATS"></a>
        <tr>
            <th style="text-align:center">DEATHSTATS</th>
            <th style="text-align:center">Quand un joueur succombe de ses statistiques</th>
            <th style="text-align:center">true</th>
        </tr>
    </thead>
    <tbody align="center">
        <a name="DEATHSTATSDISCORDWEBHOOKS"></a>
        <tr>
            <td style="text-align:center">DEATHSTATSDISCORDWEBHOOKS</td>
            <td style="text-align:center">Activé/désactivé les webkooks Discord pour l'événement</td>
            <td style="text-align:center">true</td>
        </tr>
        <a name="DEATHSTATSDISCORDWEBHOOKSLINKS"></a>
        <tr>
            <td style="text-align:center">DEATHSTATSDISCORDWEBHOOKSLINKS</td>
            <td style="text-align:center">Le/les lien(s) du/des webhook(s) Discord pour l'événement</td>
            <td style="text-align:center">Optionnel si DISCORDWEBHOOKSLINKS est définie</td>
        </tr>
        <a name="DEATHSTATSDISCORDWEBHOOKSNAME"></a>
        <tr>
            <td style="text-align:center">DEATHSTATSDISCORDWEBHOOKSNAME</td>
            <td style="text-align:center">Le nom du webhook Discord pour l'événement</td>
            <td style="text-align:center">Optionnel si DISCORDWEBHOOKSNAME est définie</td>
        </tr>
        <a name="DEATHSTATSDISCORDWEBHOOKSICONURL"></a>
        <tr>
            <td style="text-align:center">DEATHSTATSDISCORDWEBHOOKSICONURL</td>
            <td style="text-align:center">L'url de l'icône du webhook Discord pour l'événement</td>
            <td style="text-align:center">Optionnel si DISCORDWEBHOOKSICONURL est définie</td>
        </tr>
        <a name="DEATHSTATSCOLOR"></a>
        <tr>
            <td style="text-align:center">DEATHSTATSCOLOR</td>
            <td style="text-align:center">La couleur de l'embed pour l'événement</td>
            <td style="text-align:center">#d80000</td>
        </tr>
        <a name="DEATHSTATSINLINE"></a>
        <tr>
            <td style="text-align:center">DEATHSTATSINLINE</td>
            <td style="text-align:center">Aligner tout les champs</td>
            <td style="text-align:center">false</td>
        </tr>
    </tbody>
...
<table>
    <thead align="center">
        <a name="DEATHSUICIDE"></a>
        <tr>
            <th style="text-align:center">DEATHSUICIDE</th>
            <th style="text-align:center">Quand un joueur se suicide</th>
            <th style="text-align:center">true</th>
        </tr>
    </thead>
    <tbody align="center">
        <a name="DEATHSUICIDEDISCORDWEBHOOKS"></a>
        <tr>
            <td style="text-align:center">DEATHSUICIDEDISCORDWEBHOOKS</td>
            <td style="text-align:center">Activé/désactivé les webkooks Discord pour l'événement</td>
            <td style="text-align:center">true</td>
        </tr>
        <a name="DEATHSUICIDEDISCORDWEBHOOKSLINKS"></a>
        <tr>
            <td style="text-align:center">DEATHSUICIDEDISCORDWEBHOOKSLINKS</td>
            <td style="text-align:center">Le/les lien(s) du/des webhook(s) Discord pour l'événement</td>
            <td style="text-align:center">Optionnel si DISCORDWEBHOOKSLINKS est définie</td>
        </tr>
        <a name="DEATHSUICIDEDISCORDWEBHOOKSNAME"></a>
        <tr>
            <td style="text-align:center">DEATHSUICIDEDISCORDWEBHOOKSNAME</td>
            <td style="text-align:center">Le nom du webhook Discord pour l'événement</td>
            <td style="text-align:center">Optionnel si DISCORDWEBHOOKSNAME est définie</td>
        </tr>
        <a name="DEATHSUICIDEDISCORDWEBHOOKSICONURL"></a>
        <tr>
            <td style="text-align:center">DEATHSUICIDEDISCORDWEBHOOKSICONURL</td>
            <td style="text-align:center">L'url de l'icône du webhook Discord pour l'événement</td>
            <td style="text-align:center">Optionnel si DISCORDWEBHOOKSICONURL est définie</td>
        </tr>
        <a name="DEATHSUICIDECOLOR"></a>
        <tr>
            <td style="text-align:center">DEATHSUICIDECOLOR</td>
            <td style="text-align:center">La couleur de l'embed pour l'événement</td>
            <td style="text-align:center">#d80000</td>
        </tr>
        <a name="DEATHSUICIDEINLINE"></a>
        <tr>
            <td style="text-align:center">DEATHSUICIDEINLINE</td>
            <td style="text-align:center">Aligner tout les champs</td>
            <td style="text-align:center">false</td>
        </tr>
    </tbody>
...
<table>
    <thead align="center">
        <a name="DEATHBLEEDING"></a>
        <tr>
            <th style="text-align:center">DEATHBLEEDING</th>
            <th style="text-align:center">Quand un joueur succombe à ses blessures</th>
            <th style="text-align:center">true</th>
        </tr>
    </thead>
    <tbody align="center">
        <a name="DEATHBLEEDINGDISCORDWEBHOOKS"></a>
        <tr>
            <td style="text-align:center">DEATHBLEEDINGDISCORDWEBHOOKS</td>
            <td style="text-align:center">Activé/désactivé les webkooks Discord pour l'événement</td>
            <td style="text-align:center">true</td>
        </tr>
        <a name="DEATHBLEEDINGDISCORDWEBHOOKSLINKS"></a>
        <tr>
            <td style="text-align:center">DEATHBLEEDINGDISCORDWEBHOOKSLINKS</td>
            <td style="text-align:center">Le/les lien(s) du/des webhook(s) Discord pour l'événement</td>
            <td style="text-align:center">Optionnel si DISCORDWEBHOOKSLINKS est définie</td>
        </tr>
        <a name="DEATHBLEEDINGDISCORDWEBHOOKSNAME"></a>
        <tr>
            <td style="text-align:center">DEATHBLEEDINGDISCORDWEBHOOKSNAME</td>
            <td style="text-align:center">Le nom du webhook Discord pour l'événement</td>
            <td style="text-align:center">Optionnel si DISCORDWEBHOOKSNAME est définie</td>
        </tr>
        <a name="DEATHBLEEDINGDISCORDWEBHOOKSICONURL"></a>
        <tr>
            <td style="text-align:center">DEATHBLEEDINGDISCORDWEBHOOKSICONURL</td>
            <td style="text-align:center">L'url de l'icône du webhook Discord pour l'événement</td>
            <td style="text-align:center">Optionnel si DISCORDWEBHOOKSICONURL est définie</td>
        </tr>
        <a name="DEATHBLEEDINGCOLOR"></a>
        <tr>
            <td style="text-align:center">DEATHBLEEDINGCOLOR</td>
            <td style="text-align:center">La couleur de l'embed pour l'événement</td>
            <td style="text-align:center">#d80000</td>
        </tr>
        <a name="DEATHBLEEDINGINLINE"></a>
        <tr>
            <td style="text-align:center">DEATHBLEEDINGINLINE</td>
            <td style="text-align:center">Aligner tout les champs</td>
            <td style="text-align:center">false</td>
        </tr>
    </tbody>
...
<table>
    <thead align="center">
        ...
        <tr>
            ...
            <th style="text-align:center">Quand un joueur place un objet</th>
            <th style="text-align:center">true</th>
        </tr>
    </thead>
    <tbody align="center">
        <a name="PLACEMENTDISCORDWEBHOOKS"></a>
        <tr>
            <td style="text-align:center">PLACEMENTDISCORDWEBHOOKS</td>
            <td style="text-align:center">Activé/désactivé les webkooks Discord pour l'événement</td>
            <td style="text-align:center">true</td>
        </tr>
        <a name="PLACEMENTDISCORDWEBHOOKSLINKS"></a>
        <tr>
            <td style="text-align:center">PLACEMENTDISCORDWEBHOOKSLINKS</td>
            <td style="text-align:center">Le/les lien(s) du/des webhook(s) Discord pour l'événement</td>
            <td style="text-align:center">Optionnel si DISCORDWEBHOOKSLINKS est définie</td>
        </tr>
        <a name="PLACEMENTDISCORDWEBHOOKSNAME"></a>
        <tr>
            <td style="text-align:center">PLACEMENTDISCORDWEBHOOKSNAME</td>
            <td style="text-align:center">Le nom du webhook Discord pour l'événement</td>
            <td style="text-align:center">Optionnel si DISCORDWEBHOOKSNAME est définie</td>
        </tr>
        <a name="PLACEMENTDISCORDWEBHOOKSICONURL"></a>
        <tr>
            <td style="text-align:center">PLACEMENTDISCORDWEBHOOKSICONURL</td>
            <td style="text-align:center">L'url de l'icône du webhook Discord pour l'événement</td>
            <td style="text-align:center">Optionnel si DISCORDWEBHOOKSICONURL est définie</td>
        </tr>
        <a name="PLACEMENTCOLOR"></a>
        <tr>
            <td style="text-align:center">PLACEMENTCOLOR</td>
            <td style="text-align:center">La couleur de l'embed pour l'événement</td>
            <td style="text-align:center">#a459ff</td>
        </tr>
        <a name="PLACEMENTINLINE"></a>
        <tr>
            <td style="text-align:center">PLACEMENTINLINE</td>
            <td style="text-align:center">Aligner tout les champs</td>
            <td style="text-align:center">false</td>
        </tr>
    </tbody>
...
<table>
    <thead align="center">
        ...
        <tr>
            ...
            <th style="text-align:center">Quand un joueur construit un objet</th>
            <th style="text-align:center">true</th>
        </tr>
    </thead>
    <tbody align="center">
        <a name="BUILTDISCORDWEBHOOKS"></a>
        <tr>
            <td style="text-align:center">BUILTDISCORDWEBHOOKS</td>
            <td style="text-align:center">Activé/désactivé les webkooks Discord pour l'événement</td>
            <td style="text-align:center">true</td>
        </tr>
        <a name="BUILTDISCORDWEBHOOKSLINKS"></a>
        <tr>
            <td style="text-align:center">BUILTDISCORDWEBHOOKSLINKS</td>
            <td style="text-align:center">Le/les lien(s) du/des webhook(s) Discord pour l'événement</td>
            <td style="text-align:center">Optionnel si DISCORDWEBHOOKSLINKS est définie</td>
        </tr>
        <a name="BUILTDISCORDWEBHOOKSNAME"></a>
        <tr>
            <td style="text-align:center">BUILTDISCORDWEBHOOKSNAME</td>
            <td style="text-align:center">Le nom du webhook Discord pour l'événement</td>
            <td style="text-align:center">Optionnel si DISCORDWEBHOOKSNAME est définie</td>
        </tr>
        <a name="BUILTDISCORDWEBHOOKSICONURL"></a>
        <tr>
            <td style="text-align:center">BUILTDISCORDWEBHOOKSICONURL</td>
            <td style="text-align:center">L'url de l'icône du webhook Discord pour l'événement</td>
            <td style="text-align:center">Optionnel si DISCORDWEBHOOKSICONURL est définie</td>
        </tr>
        <a name="BUILTCOLOR"></a>
        <tr>
            <td style="text-align:center">BUILTCOLOR</td>
            <td style="text-align:center">La couleur de l'embed pour l'événement</td>
            <td style="text-align:center">#f03ee8</td>
        </tr>
        <a name="BUILTINLINE"></a>
        <tr>
            <td style="text-align:center">BUILTINLINE</td>
            <td style="text-align:center">Aligner tout les champs</td>
            <td style="text-align:center">false</td>
        </tr>
    </tbody>
...
<table>
    <thead align="center">
        <a name="DISMANTLED"></a>
        <tr>
            <th style="text-align:center">DISMANTLED</th>
            <th style="text-align:center">Quand un joueur démonte un objet</th>
            <th style="text-align:center">true</th>
        </tr>
    </thead>
    <tbody align="center">
        <a name="DISMANTLEDDISCORDWEBHOOKS"></a>
        <tr>
            <td style="text-align:center">DISMANTLEDDISCORDWEBHOOKS</td>
            <td style="text-align:center">Activé/désactivé les webkooks Discord pour l'événement</td>
            <td style="text-align:center">true</td>
        </tr>
        <a name="DISMANTLEDDISCORDWEBHOOKSLINKS"></a>
        <tr>
            <td style="text-align:center">DISMANTLEDDISCORDWEBHOOKSLINKS</td>
            <td style="text-align:center">Le/les lien(s) du/des webhook(s) Discord pour l'événement</td>
            <td style="text-align:center">Optionnel si DISCORDWEBHOOKSLINKS est définie</td>
        </tr>
        <a name="DISMANTLEDDISCORDWEBHOOKSNAME"></a>
        <tr>
            <td style="text-align:center">DISMANTLEDDISCORDWEBHOOKSNAME</td>
            <td style="text-align:center">Le nom du webhook Discord pour l'événement</td>
            <td style="text-align:center">Optionnel si DISCORDWEBHOOKSNAME est définie</td>
        </tr>
        <a name="DISMANTLEDDISCORDWEBHOOKSICONURL"></a>
        <tr>
            <td style="text-align:center">DISMANTLEDDISCORDWEBHOOKSICONURL</td>
            <td style="text-align:center">L'url de l'icône du webhook Discord pour l'événement</td>
            <td style="text-align:center">Optionnel si DISCORDWEBHOOKSICONURL est définie</td>
        </tr>
        <a name="DISMANTLEDCOLOR"></a>
        <tr>
            <td style="text-align:center">DISMANTLEDCOLOR</td>
            <td style="text-align:center">La couleur de l'embed pour l'événement</td>
            <td style="text-align:center">#00d7f1</td>
        </tr>
        <a name="DISMANTLEDINLINE"></a>
        <tr>
            <td style="text-align:center">DISMANTLEDINLINE</td>
            <td style="text-align:center">Aligner tout les champs</td>
            <td style="text-align:center">false</td>
        </tr>
    </tbody>
...
<table>
    <thead align="center">
        <a name="PLAYERSLIST"></a>
        <tr>
            <th style="text-align:center">PLAYERSLIST</th>
            <th style="text-align:center">Quand la liste des joueurs est actualisé</th>
            <th style="text-align:center">true</th>
        </tr>
    </thead>
    <tbody align="center">
        <a name="PLAYERSLISTDISCORDWEBHOOKS"></a>
        <tr>
            <td style="text-align:center">PLAYERSLISTDISCORDWEBHOOKS</td>
            <td style="text-align:center">Activé/désactivé les webkooks Discord pour l'événement</td>
            <td style="text-align:center">true</td>
        </tr>
        <a name="PLAYERSLISTDISCORDWEBHOOKSLINKS"></a>
        <tr>
            <td style="text-align:center">PLAYERSLISTDISCORDWEBHOOKSLINKS</td>
            <td style="text-align:center">Le/les lien(s) du/des webhook(s) Discord pour l'événement</td>
            <td style="text-align:center">Optionnel si DISCORDWEBHOOKSLINKS est définie</td>
        </tr>
        <a name="PLAYERSLISTDISCORDWEBHOOKSNAME"></a>
        <tr>
            <td style="text-align:center">PLAYERSLISTDISCORDWEBHOOKSNAME</td>
            <td style="text-align:center">Le nom du webhook Discord pour l'événement</td>
            <td style="text-align:center">Optionnel si DISCORDWEBHOOKSNAME est définie</td>
        </tr>
        <a name="PLAYERSLISTDISCORDWEBHOOKSICONURL"></a>
        <tr>
            <td style="text-align:center">PLAYERSLISTDISCORDWEBHOOKSICONURL</td>
            <td style="text-align:center">L'url de l'icône du webhook Discord pour l'événement</td>
            <td style="text-align:center">Optionnel si DISCORDWEBHOOKSICONURL est définie</td>
        </tr>
        <a name="PLAYERSLISTCOLOR"></a>
        <tr>
            <td style="text-align:center">PLAYERSLISTCOLOR</td>
            <td style="text-align:center">La couleur de l'embed pour l'événement</td>
            <td style="text-align:center">#e4d800</td>
        </tr>
        <a name="PLAYERSLISTINLINE"></a>
        <tr>
            <td style="text-align:center">PLAYERSLISTINLINE</td>
            <td style="text-align:center">Aligner tout les champs</td>
            <td style="text-align:center">false</td>
        </tr>
    </tbody>
...
<a name="changement"></a>
<h2>Changement - <a href="#à-venir">suivant</a> | <a href="#utilisation">précédent</a> | <a href="#top">début</a> | <a href="#bottom">fin</a></h2>

<a href="./CHANGELOG.md" target="_blank">Visualiser CHANGELOG.md pour voir les changements.</a>

<a name="à-venir"></a>
<h2>À venir - <a href="#faq">suivant</a> | <a href="#changement">précédent</a> | <a href="#top">début</a> | <a href="#bottom">fin</a></h2>

<ul>
    <li>DayZ Logger disponible depuis le Steam Workshop (donc en mod) pour une utilisation optimal des événements DayZ.</li>
    <li>Diminution des paramètres à définir.</li>
    <li>DayZ Logger disponible aussi en ligne de commande.</li>
    <li>Amélioration de l'événement <code>PLAYER_LIST</code></li>
    <li>Simplification de l'utilisation.</li>
    <li>Fonctions disponible aussi en asynchronisé.</li>
</ul>

<a name="faq"></a>
<h2>FAQ - <a href="#contributeurs">suivant</a> | <a href="#à-venir">précédent</a> | <a href="#top">début</a> | <a href="#bottom">fin</a></h2>

<h3>Peut-on intégré DayZ Logger dans d'autres projets ?</h3>

<p>Oui, une <a href="./api.js" target="_blank">api</a> est disponible.</p>

<h3>Comment fait-on pour contribuer ?</h3>

<p>Vous pouvez soit me <a href="#contact">contacter</a> ou soit ouvrir un <a href="https://github.com/AlexAnimateMP4/Dayz-Logger/issues" target="_blank">ticket</a>.</p>

<a name="contributeurs"></a>
<h2>Contributeurs - <a href="#contact">suivant</a> | <a href="#faq">précédent</a> | <a href="#top">début</a> | <a href="#bottom">fin</a></h2>

<p>Pour l'instant, il y a aucun contributeur mais peut-être qu'il y'en aura à l'avenir !</p>
...
<p>Inspiré de <a href="https://github.com/0x346e3730/DayZ-BigBrother" target="_blank">DayZ BigBrother</a> par <a href="https://github.com/0x346e3730" target="_blank">Antonin CLAUZIER</a></p>

<a name="licence"></a>
<h2>Licence - <a href="#liste-des-dépendances">suivant</a> | <a href="#crédit">précédent</a> | <a href="#top">début</a> | <a href="#bottom">fin</a></h2>

<p>DayZ Logger est disponible sous la licence <a href="https://choosealicense.com/licenses/mpl-2.0" target="_blank">Mozilla Public License 2.0</a><br>
<a href="./LICENSE" target="_blank">Voir la licence</a></p>

<a name="liste-des-dépendances"></a>
<h2>Liste des dépendances - <a href="#licence">précédent</a> | <a href="#top">début</a></h2>

<ul>
    <li><a name="axios" href="https://www.npmjs.com/package/axios" target="_blank">axios</a></li>
    <li><a name="dotenv" href="https://www.npmjs.com/package/dotenv" target="_blank">dotenv</a></li>
    <li><a name="envfile" href="https://www.npmjs.com/package/envfile" target="_blank">envfile</a></li>
    <li><a name="tail" href="https://www.npmjs.com/package/tail" target="_blank">tail</a></li>
    <li><a name="discord.js" href="https://discord.js.org/#/docs" target="_blank">discord.js</a></li>
</ul>

<p align="center">&copy; 2021 <a href="https://github.com/AlexAnimateMP4/Dayz-Logger">DayZ Logger</a><br>&lt;/&gt; avec ❤ par <a href="https://github.com/AlexAnimateMP4" target="_blank">Alex Animate Mp4</a></p>
<a name="bottom"></a>
